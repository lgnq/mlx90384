...
#define MLX90384_DSP_BASE_ADDR              0x000
#define MLX90384_NVRAM_BASE_ADDR            0x200
...
#define MLX90384_LIN_PHASE                  0x03A   //Angular value after linearization, resolution 360/216 deg; Writable only with LOCK_PHASE = 1; Before delay compensation
#define MLX90384_SPEED                      0x03C
#define MLX90384_DRIFTC_PHASE               0x042   //Angular value after delay compensation and zero-point offset correction, resolution 360/0x10000 deg
#define MLX90384_SC_PHASE                   0x044   //Position value after signal conditioning
#define MLX90384_GC_I                       0x048   //Gain compensated I component
#define MLX90384_GC_Q                       0x04E   //Gain compensated Q component
